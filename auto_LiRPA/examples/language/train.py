...
ptb = PerturbationSynonym(budget=args.budget)## we need a separate perturbation
dummy_embeddings = BoundedTensor(dummy_embeddings, ptb)## need to add some metadata, in case
...
if isinstance(model_ori, BoundedModule):
    ...
    model_bound = BoundedModule(## we need to make changes here
